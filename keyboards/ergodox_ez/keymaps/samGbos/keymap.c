...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LCTRL, KC_A,   KC_S,  LT(NUM, KC_D), LT(FUNC, KC_F), KC_G,                            KC_H,  KC_J,     KC_K,     KC_L,    KC_SCLN,   KC_ENT,
  KC_LSFT,  KC_Z,   KC_X,  KC_C,          KC_V,           KC_B,  KC_EQL,        KC_MINUS,  KC_N,  KC_M,     KC_COMM,  KC_DOT,  KC_SLSH,   KC_RSFT,
  MO(FUNC), KC_NO,  KC_NO, KC_LALT,       KC_LCMD,                                                KC_LEFT,  KC_DOWN,  KC_UP,   KC_RIGHT,  KC_NO,
                                                 KC_F4, KC_F3,    KC_F7, KC_F8,
                                                        KC_F2,    KC_F6,
                                       MT(MOD_LSFT, KC_SPC), KC_LEAD, KC_F1,    KC_F5, KC_QUOT, MO(SYMB)
),
/* Keymap 1: linux
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
...
[LINUX] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_TRNS,  KC_TRNS,   KC_TRNS,     KC_TRNS,     KC_TRNS,  KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,     KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,
  KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_LCTRL,                                      KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,
